...
public class EmptyLayout {
	...
	private String mErrorMessage = "发生了错误";
	private String mEmptyMessage = "数据为空";
	private String mLoadingMessage = "请稍后";
	...
	private void setDefaultValues() {
		if (mEmptyView==null) {
			mEmptyView = (ViewGroup) mInflater.inflate(R.layout.el_view_empty, null);
		...
		if (mLoadingView==null) {
			mLoadingView = (ViewGroup) mInflater.inflate(R.layout.el_view_loading, null);
		...
		if (mErrorView==null) {
			mErrorView = (ViewGroup) mInflater.inflate(R.layout.el_view_error, null);
